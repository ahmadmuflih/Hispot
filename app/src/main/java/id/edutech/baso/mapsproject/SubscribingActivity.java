...
public class SubscribingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Subscribing");
        ...
        Call<ArrayList<Subscribe>> subscribersCall = APIService.service.getSubscribing("subscribing",api_key);
        subscribersCall.enqueue(new Callback<ArrayList<Subscribe>>() {
            ...
            public void onResponse(Call<ArrayList<Subscribe>> call, Response<ArrayList<Subscribe>> response) {
                if(response.isSuccessful()){
                    ArrayList<Subscribe> subscribing = response.body();
                    SubscribeAdapter adapter = new SubscribeAdapter(getApplicationContext(),subscribing);
                    ...
                    Toast.makeText(getApplicationContext(), "Unable to load subscribing, please check your internet connection!", Toast.LENGTH_SHORT).show();
                }
